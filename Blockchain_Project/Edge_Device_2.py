...
def update_chain():
    ...
    if is_valid_updated:
        response = {'message':'Medical Blockchain Updated',
                    'updated_chain': medicalchain.virtualchain }
    else:
        response = {'message':' Chain is up to date',
